...
namespace main_savitch_5
{
    ...
    public:
        ...
        value_type current( ) const;
    private:
        node *head_ptr; // The head pointer on the list
        node *tail_ptr; //The tail pointer on the list
        node *cursor; //Pointer to node with current item
        node *precursor; //Points to node before the current item
